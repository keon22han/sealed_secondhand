...
import com.example.sealed_secondhand.recyclerview.ChatDiffUtil
...
class ChatActivity : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chatRecyclerAdapter = ChatRecyclerAdapter(ChatDiffUtil())
        ...
        chatList.add(chat11)
        chatRecyclerAdapter.submitList(chatList)
